...
- **Whisper 转录** — 本地运行 faster-whisper，支持 tiny.en ~ large-v3 多档模型，GPU (CUDA) 自动加速
...
- [FFmpeg](https://ffmpeg.org/)（已内置在 `bin/` 目录中）
- NVIDIA GPU + CUDA（可选，CPU 也能跑但慢）
...
# 4. 下载 yt-dlp 和 FFmpeg 到 bin/ 目录
#    yt-dlp: https://github.com/yt-dlp/yt-dlp/releases
#    FFmpeg: https://ffmpeg.org/download.html
#    将 yt-dlp.exe, ffmpeg.exe, ffplay.exe, ffprobe.exe 放入 bin/
...
```
videosub/
├── main.py                  # Python: faster-whisper 转录脚本
